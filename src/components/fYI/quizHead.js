...
const QuizHead = () => {
  ...
  <div>
      ...
      <Card.Header as="h3"> Get Daily Flipkart  <span style={{color:"red"}}> <b>For Your Information(FYI)</b>
      </span>  Quiz answers
    ...
    amazing Gifts and earn Flipkart super coins.
       ...
       <Card.Subtitle>get flipkart <b> FYI</b> Quiz answers daily<span style={{color:"red"}}> in
