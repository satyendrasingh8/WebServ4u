...
const QuizHead = ({curDate}) => {
  ...
  <div>
   ...
   <Card.Header as="h3"> Get Daily Flipkart <b style={{color:"red"}}>Kya Bolti Public</b> answers
 ...
 amazing Gifts and earn Flipkart super coins.
    ...
    <b style={{padding:'15px'}}>get flipkart <b>Kya Bolti Public</b> Quiz answers <span> <b> 
