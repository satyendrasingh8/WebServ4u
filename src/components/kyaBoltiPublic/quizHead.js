...
const QuizHead = () => {
  ...
  <div>
      ...
      <Card.Header as="h3"> Get Daily Flipkart  <span style={{color:"red"}}> Kya Bolti Public?</span>  Quiz answers
    ...
    amazing Gifts and earn Flipkart super coins.
       ...
       <Card.Subtitle>get flipkart<b>Kya Bolti Public</b> Quiz answers daily<span style={{color:"red"}}> in
