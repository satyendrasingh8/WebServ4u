...
<ol type="1">
    ...
    <li><a href="#externallinks"><strong>External Links Disclaimer</strong></a>
</li>
    <li><a href="#reviews"><strong>Reviews</strong></a>
</li>
    <li><a href="#earnings"><strong>Earnings Disclaimer</strong></a>
</li>
    <li><a href="#testimonials"><strong>Testimonials Disclaimer</strong></a>
</li>
    <li><a href="#professionalrelationship"><strong>No Professional Relationship Disclaimer</strong></a>
</li>
...
<p><a href="#tableofcontents">Back to table of contents</a></p><h2 id="externallinks">2 External Links Disclaimer</h2><p>The Website may contain (or You may be sent through the Website links to other sites or content belonging to or originating from third parties or links to sites and features in banners or other advertising. We do not investigate, monitor, or check such external links for accuracy, adequacy, validity, reliability, availability or completeness.</p>
...
<p><a href="#tableofcontents">Back to table of contents</a></p><h2 id="reviews">3 Reviews</h2><p>At various times, We may provide reviews of products, services, or other resources. This may include reviews of books, services, and/or software applications. Any such reviews will represent the good-faith opinions of the author of such review. The products and services reviewed may be provided to Us for free or at a reduced price as an incentive to provide a review.</p>
...
<p>We will disclose the existence of any discounts or incentives received in exchange for providing a review of a product. If You would like more information about any such discounts and incentives, send an email to satyendrasinghsss7398@gmail.com that includes the title of the reviewed product as the subject line. We will respond via email and disclose any incentives or discounts We received in association with any such review.</p>

<p><a href="#tableofcontents">Back to table of contents</a></p><h2 id="earnings">4 Earnings Disclaimer</h2><p>From time to time, We may report on the success of one of Our existing or prior clients/customers. The information about this success is accurately portrayed by the clients/customers. You acknowledge that the prior success of others does not guarantee Your success.</p>
...
<p>The use of Our information, products, and services should be based on Your own due diligence and You agree that We are not liable for any success or failure of Your business that is directly or indirectly related to the purchase and use of Our information, products, and services reviewed or advertised on this Website.</p>

<p><a href="#tableofcontents">Back to table of contents</a></p><h2 id="testimonials">5 Testimonials Disclaimer</h2><p>The Website may contain testimonials from users of Our products and/or services. These testimonials reflect the real-life experiences and opinions of such users. However, the experiences are personal to those particular users, and may not necessarily be representative of all users of Our products and/or services. We do not claim, and You should not assume, that all users will have the same experiences. Your individual results may vary.</p>
<p>The testimonials on the Website are <a href="https://happyholi.webserv4u.com/" >happyholi</a> submitted in various forms such as text, audio and/or video, and are reviewed by Us before being posted. They appear on the Website verbatim as given by the users, except for the correction of grammar or typing errors. Some testimonials may have been shortened for the sake of brevity where the full testimonial contained extraneous information not relevant to the general public.</p>
...
<p><a href="#tableofcontents">Back to table of contents</a></p><h2 id="professionalrelationship">6 No Professional Relationship Disclaimer</h2><p><strong>The Website cannot and does not contain professional advice. </strong>We do not provide any kind of professional advice. The information is provided for general informational and educational purposes only and is not a substitute for professional advice.</p>
...
<p><a href="#tableofcontents">Back to table of contents</a></p><h2 id="maps">7 Maps Policy</h2><p>The map used on Our Website is published on the web by Google and sourced under an open license. The boundaries, names shown, and the designations used on this map do not imply the expression of any opinion whatsoever on Our part or its people in respect of the legal status of any country, territory, city or area, or the delimitation of any frontiers or boundaries.</p>

<p><a href="#tableofcontents">Back to table of contents</a></p><h2 id="fairuse">8 Fair Use Notice</h2><p>The Website contains copyrighted material the use of which has not always been specifically authorized by the copyright owner. We believe this constitutes a “fair use” of any such copyrighted material as provided for in section 107 of the US Copyright Law. If You wish to use copyrighted material from the Website for purposes of Your own that go beyond fair use, You must obtain permission from the copyright owner.</p>

<p><a href="#tableofcontents">Back to table of contents</a></p><h2 id="personal">9 Personal Responsibility</h2><p>You acknowledge You are using Our Website voluntarily and that any choices, actions and results now and in the future are solely Your responsibility.</p>
...
<p><a href="#tableofcontents">Back to table of contents</a></p><h2 id="contact">10 Contact Us</h2><p>If You require any more information or have any questions about Our Website's disclaimer, please feel free to contact Us by our <a href="/contact">contact page</a> or
  by email at&nbsp;<a href="mailto:webserv4u.com@gmail.com">webserv4u.com@gmail.com</a>.</p>

<p><a href="#tableofcontents">Back to table of contents</a></p><h2 id="copyright">11 Copyright Information</h2><p>COPYRIGHT 2021 WebServ4u.com. ALL RIGHTS RESERVED.
</p><p>This disclaimer was generated at: <a href="https://privacyterms.io/disclaimer-generator/">privacyterms.io</a>.</p>            
    </div>
  );
}
